...
pygame.display.set_caption("Wassgoodiiee Pong")
...
while run:
    ...
    if live_ball == False:
        ...
        if winner == 1:
            draw_text("LETSS GOOOOO \(^o^)/", font, white, 220, screen_height // 2 -100 )
            draw_text("CLICK ANYWHERE TO START", font, white, 100, screen_height // 2 - 50 )
        if  winner == -1:
            draw_text("WOW, THATS CRAZY. . YOU SUCK", font, white, 100, screen_height // 2 -100 )
            draw_text("CLICK ANYWHERE TO START", font, white, 100, screen_height // 2 - 50 )
